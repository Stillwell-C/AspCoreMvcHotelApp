...
{
    public class BookingViewModel_EnsureValidTotalRate: ValidationAttribute
    {
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
            ...
            {
                if (bookingViewModel.Booking.RateTotal < 1)
                {
                ...
                if (rateConfirmation != null && bookingViewModel.Booking.RateTotal != (rateConfirmation.Rates_from * bookingViewModel.Booking.BookingDayDuration))
                {
                    return new ValidationResult("Invalid nightly rate. Please try again.");
                }
            }
